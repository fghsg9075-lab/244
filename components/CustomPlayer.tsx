    ...
    return (
        <div className="relative w-full h-full bg-black group overflow-hidden" style={{ minHeight: '300px' }}>
             ...
             {(blockShare !== false || brandingLogoConfig?.topBlockHeight) && (
                 <div 
                    className="absolute top-0 left-0 right-0 z-50 bg-black pointer-events-auto" 
                    style={{ 
                        height: `${brandingLogoConfig?.topBlockHeight || 60}px`,
             ...
             <div 
                className="absolute bottom-0 right-0 z-50 bg-black pointer-events-auto" 
                style={{ 
